      ...
      <Card className="overflow-hidden border-none shadow-md">
        <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
          <div className="flex items-center">
            ...
            <CardTitle className="text-xl font-semibold">Fraudulent Apps</CardTitle>
          </div>
        </CardHeader>
              ...
              >
                <div className="p-4 sm:p-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-muted-foreground mb-4">
                    <div className="flex items-center">
                      <span className="font-medium text-foreground mr-1">Developer:</span> {app.developer}
                    </div>
                    <div className="flex items-center">
                      <span className="font-medium text-foreground mr-1">Category:</span> {app.category}
                    </div>
                    <div className="flex items-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button onClick={() => handleAction("app", app._id, "block")} variant="destructive" size="sm">
                      Block
                    </Button>
                    <Button
      ...
      <Card className="overflow-hidden border-none shadow-md">
        <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 border-b">
          <div className="flex items-center">
            ...
            <CardTitle className="text-xl font-semibold">Fraudulent URLs</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="p-6">
          <div className="grid gap-4">
            {fraudulent_urls.map((urlData: any) => (
              ...
              >
                <div className="p-4 sm:p-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-muted-foreground mb-4">
                    <div className="flex items-center">
                      <span className="font-medium text-foreground mr-1">Category:</span> {urlData.category}
                    </div>
                    <div className="flex items-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button onClick={() => handleAction("url", urlData._id, "block")} variant="destructive" size="sm">
                      Block
                    </Button>
                    <Button
